...
import { MapPin, Calendar, Users, Star, Clock, Plus, Trash2, Send, X } from 'lucide-react';
  ...
  const generateItinerary = async () => {
    ...
    try {
      ...
      const response = await axiosClient.post("api/ai/chat", {
        systemPrompt: "You are a travel itinerary expert. Create detailed, day-by-day travel itineraries that are practical and engaging. Format your response using markdown with headers, lists, and emphasis.",
    ...
    <div className="min-h-screen bg-gray-50 p-4 lg:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Create Your Perfect Itinerary</h1>
          ...
          <div className="xl:col-span-3">
            ...
            <div className="space-y-4">
              ...
              {filteredExperiences.map((experience) => (
                <div key={experience.id} className="bg-white rounded-xl shadow-sm p-4 lg:p-6 hover:shadow-md transition-shadow">
                  <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="lg:w-2/3">
                      <div className="flex flex-col sm:flex-row justify-between items-start mb-2">
                        <h4 className="text-xl font-semibold text-gray-900 mb-2 sm:mb-0">{experience.title}</h4>
                        <span className="text-2xl font-bold text-blue-600 whitespace-nowrap">${experience.price}/night</span>
                      </div>
                      <p className="text-gray-600 mb-3">Hosted by {experience.host}</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6 sticky top-6">
              ...
              {selectedExperiences.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 text-sm">Select experiences to build your itinerary</p>
                </div>
              ) : (
                <div className="space-y-3">
                  <div className="max-h-96 overflow-y-auto space-y-3">
                    {selectedExperiences.map((experience) => (
                      <div key={experience.id} className="border border-gray-200 rounded-lg p-3 hover:bg-gray-50 transition-colors">
                        <div className="flex justify-between items-start mb-2">
                          <h5 className="font-semibold text-sm leading-tight pr-2">{experience.title}</h5>
                          <button
                        ...
                        <div className="flex items-center gap-1 mb-1">
                          ...
                          <p className="text-xs text-gray-500 truncate">{experience.location}</p>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium text-blue-600">${experience.price}/night</span>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <h3 className="text-xl font-bold text-gray-900">Your Custom Itinerary</h3>
                <button
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                <div className="prose prose-gray max-w-none prose-headings:text-gray-900 prose-h1:text-2xl prose-h1:font-bold prose-h1:mb-6 prose-h1:mt-8 prose-h1:pb-2 prose-h1:border-b prose-h1:border-gray-200 prose-h2:text-xl prose-h2:font-semibold prose-h2:mb-4 prose-h2:mt-6 prose-h3:text-lg prose-h3:font-semibold prose-h3:mb-3 prose-h3:mt-5 prose-p:text-gray-700 prose-p:leading-relaxed prose-p:mb-4 prose-strong:text-gray-900 prose-strong:font-semibold prose-em:text-gray-600 prose-ul:mb-4 prose-ol:mb-4 prose-li:mb-1 prose-li:text-gray-700">
                  <ReactMarkdown 
                    ...
                    components={{
                      h1: ({node, ...props}) => <h1 className="text-2xl font-bold mb-6 mt-8 pb-2 border-b border-gray-200 text-gray-900" {...props} />,
                      h2: ({node, ...props}) => <h2 className="text-xl font-semibold mb-4 mt-6 text-gray-900" {...props} />,
                      h3: ({node, ...props}) => <h3 className="text-lg font-semibold mb-3 mt-5 text-gray-900" {...props} />,
