  ...
  return (
    <main className="container mx-auto px-4 py-12">
      <section
        ...
        style={{
          backgroundImage:
            "url('https://budgetyatri.com/wp-content/uploads/Konkani-village-savitri-river.jpg')",
        }}
      >
        ...
        <div className="relative z-10 text-white max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-2xl mb-10 max-w-2xl mx-auto font-medium opacity-90">
            Discover authentic homestays, vibrant traditions, and sustainable
            adventures.
          </p>
          <Link href={"/experience"}>
            <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-10 rounded-full text-xl transition-all duration-300 transform hover:scale-105 shadow-xl border-2 border-white focus:outline-none focus:ring-4 focus:ring-green-300">
              Explore Experiences
            </button>
          </Link>
        </div>
      ...
      <section className="py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 text-center border border-gray-200">
            <Home
              size={60}
              className="text-green-600 mx-auto mb-6 drop-shadow-md"
            />
            <h4 className="text-2xl font-semibold mb-3 font-inter text-gray-800">
              Authentic Village Stays
            </h4>
            <p className="text-gray-600 leading-relaxed">
              Experience genuine hospitality, local cuisine, and traditional
              living in hand-picked village homes.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 text-center border border-gray-200">
            <Leaf
            ...
            <p className="text-gray-600 leading-relaxed">
              Travel responsibly, minimize your footprint, and contribute to the
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 text-center border border-gray-200">
            ...
            <p className="text-gray-600 leading-relaxed">
              Your journey directly supports local livelihoods, crafts, and the
      ...
      <section className="py-16 bg-green-50 rounded-3xl shadow-xl p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
          <div className="flex flex-col items-center p-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-green-100">
            ...
            <p className="text-gray-600 leading-relaxed">
              Browse unique homestays, cultural activities, and farm
              experiences.
            </p>
          </div>
          <div className="flex flex-col items-center p-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-green-100">
            ...
            <p className="text-gray-600 leading-relaxed">
              Confirm your stay or activity with our easy and secure booking
              process.
            </p>
          </div>
          <div className="flex flex-col items-center p-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-green-100">
      ...
      <section className="py-16 text-center">
        <h3 className="text-4xl font-bold mb-6 text-gray-800 font-inter">
          Share Your Village Story
        </h3>
        <p className="text-xl text-gray-700 mb-10 max-w-3xl mx-auto">
          Are you a rural host eager to share your home, culture, or unique
          skills? Join our growing community!
        </p>
        <Link href="/host">
          <button className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-4 px-10 rounded-full text-xl transition-all duration-300 transform hover:scale-105 shadow-xl focus:outline-none focus:ring-4 focus:ring-yellow-300">
            Become a Host Today
          </button>
        </Link>
      </section>
